...
import ru.otus.taskmanager.controller.TaskController;
...
public class TaskControllerTest {
    ...
    @Test
    public void updateTaskShouldReturnStatusOkAndFilledTaskFormAsViewNameAndTaskAsAttribute() throws Exception {
        Long id = 1L;
    ...
    @Test
    public void deleteTaskShouldInvokeDeleteTaskMethodAndRedirectToTasks() throws Exception {
        Long id = 1L;
